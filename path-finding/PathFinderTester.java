...
class PathFinderTester
{
    ...
    public static void usage(String progName) {
        ...
        System.err.println("-v will activate Assign2_s3681278_s3672349.map and path visualisation.");
        System.exit(1);
    } // end of usage
    ...
    public static void main(String[] args) {
        ...
        // number of rows and columns in Assign2_s3681278_s3672349.map
        int rowNum = 0;
        int colNum = 0;
                    ...
                    for (int i = 0; i < tokens.length; i += 2) {
                        ...
                        if (r < 0 || r >= rowNum || c < 0 || c >= colNum) {
                            throw new IllegalArgumentException(
                                    "Origin coordinates cannot be less than 0 or greater than the number of rows or columns in Assign2_s3681278_s3672349.map.");
                        }
            ...
            if ((line = reader.readLine()) != null) {
                ...
                if (tokens.length < 2 || tokens.length % 2 != 0) {
                    ...
                    for (int i = 0; i < tokens.length; i += 2) {
                        ...
                        if (r < 0 || r >= rowNum || c < 0 || c >= colNum) {
                            throw new IllegalArgumentException(
                                    "Destination coordinates cannot be less than 0 or greater than the number of rows or columns in Assign2_s3681278_s3672349.map.");
                        }
        ...
        //
        // Construct Assign2_s3681278_s3672349.map
        //

        PathMap map = new PathMap();
        // load Assign2_s3681278_s3672349.map
