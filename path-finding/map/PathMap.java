...
public class PathMap {
    ...
    /**
     * Initialise the Assign2_s3681278_s3672349.map.
     *
     ...
     */
    public void initMap(int rowNum,
                        int colNum,
                        List<Coordinate> oriCells,
                        List<Coordinate> desCells,
                        Set<Coordinate> impassableCells,
                        Map<Coordinate, Integer> terrainCells,
    ...
    /**
     * Check whether coordinate (r, c) is in the Assign2_s3681278_s3672349.map.
     *
    ...
    /**
     * Check whether the coordinate is in the Assign2_s3681278_s3672349.map.
     *
     * @param coord The coordinate being checked.
     * @return True if in the Assign2_s3681278_s3672349.map. Otherwise false.
     */
    ...
    public boolean isPassable(Coordinate coordinate) {
        return isIn(coordinate) && !coordinate.getImpassable();
    }

    /**
     * Draw the Assign2_s3681278_s3672349.map in a window.
     */
    public void draw() {
    ...
    public List<Coordinate> neighbours(Coordinate c){

        List<Coordinate> temp = new ArrayList<>();
        List<Coordinate> total = getCoordinates();
        for (int i =0;i<total.size();i++){
            if (c.isNextTo(total.get(i))){
                temp.add(total.get(i));
            }
        }
        return temp;
    }
